<?php
	...
	class Authentication extends CComponent {
	    ...
	    public function authenticate() {
	        $status;
	        $facebook = new Facebook(array('appId' => '142283812604018', 'secret' => '7121bbcf50ef95cd17492631f2d68c40'));
	        ...
	        $pram = array('scope' => 'user_likes, user_location, email', 'redirect_uri' => 'http://predictions.mtv.in.com/');
	        if ($this->me) {
