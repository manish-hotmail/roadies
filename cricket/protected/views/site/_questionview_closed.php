...
if($status == 'closed') {
    ...
    if ($valid_answer){
        if($pot_distributed == "yes"){
            $disp_text = "<h6 style='text-align: center;'>Congratulations to all the winners!</h6><h5 class='question_end_info' style='text-align: center;'>Cricket Dollars has been credited based on your prediction</h5>";
        } else {
            $disp_text = "<h6 style='text-align: center;'>Congratulations to all the winners!</h6><h5 class='question_end_info' style='text-align: center;'>Cricket Dollars will be credited within 24 hours</h5>";
        }
    } else {
