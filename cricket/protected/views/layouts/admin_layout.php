	...
	<div style="width: 1040px; margin: 0 auto;">
		<div id="mainmenu" style="margin-bottom: 10px;">
			<?php $this->widget('zii.widgets.CMenu',array(                                    
				...
				'items'=>array(                                         
					array('label'=>'Manage Events', 'url'=>array('/events/index')),
					array('label'=>'|'),
					array('label'=>'Manage Transaction Types', 'url'=>array('/transactionTypes/index')),
					array('label'=>'|'),	
					array('label'=>'Infuse Money', 'url'=>array('/admin/infuseMoney')),
					array('label'=>'|'),	
					array('label'=>'Block User', 'url'=>array('/blockingData/index')),
					array('label'=>'|'),	
					array('label'=>'Analytics', 'url'=>array('/analytics/analytics')),
					array('label'=>'|'),	
					array('label'=>'Download Data', 'url'=>array('/analytics/download')),
					array('label'=>'|'),	
