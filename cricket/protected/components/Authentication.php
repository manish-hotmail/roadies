<?php
	...
	class Authentication extends CComponent {
	    ...
	    public function authenticate() {
	        $status;
	        $facebook = new Facebook(array('appId' => '414295275333239', 'secret' => '97350b6bb7236719ad2c06b23c5f4bff', 'cookie' => true));
	        ...
	        $pram = array('scope' => 'user_likes, user_location, email', 'redirect_uri' => 'http://predictions.mtv.in.com/cricket/');
	        if ($this->me) {
