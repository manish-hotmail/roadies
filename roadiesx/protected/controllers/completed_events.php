...
<p class="main_page_headers"><span>COMPLETED EVENTS</span></p>
<?php		
	$apH = "<table class='td_bg' id='completed_td'>";
		...
		foreach ($completed_events_array as $key => $event) {
			$apH .= "<tr>";
				...
				$apH .= "<td><span style='float: right; margin-top: 16px;'>". $event->winning ."</span></td>";
...
<?php
	$this->pageTitle=Yii::app()->name . ' | Closed Events';
