						...
						$.each(d[key], function (index, element) {
							if (index == "id"){
								event_id = element;
	                  			...
	                  			//html += '<p class="current_event_meta_data" style="border: none;"><span>Total PREDICTIONS: '+element+'</span></p></td>';
	                  		}
						});
					}
					html += '</table>'
	...
	function getLeaderboardData() {
		$.ajax({
			...
			success: function(response) {
				...
				html += "<tr><td>&gt;&gt; <a href='javascript:gotoLeaderBoard()'>View List</a><td></tr>";
				html +- '</table>'
				//alert(html);
