...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'total_credits'); ?>
		<?php echo $form->textField($model,'total_credits'); ?>
		<?php echo $form->error($model,'total_credits'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'total_debits'); ?>
		<?php echo $form->textField($model,'total_debits'); ?>
		<?php echo $form->error($model,'total_debits'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'closing_balance'); ?>
		<?php echo $form->textField($model,'closing_balance'); ?>
		<?php echo $form->error($model,'closing_balance'); ?>
	</div>
