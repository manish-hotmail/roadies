...
//if($status == "current"){
	...
	if ($valid_answer){
		if($pot_distributed == "yes"){
			$disp_text = "<h6 style='text-align: center;'>Congratulations to all the winners!</h6><h5 class='question_end_info' style='text-align: center;'>Roadies Dollars has been credited based on your predictions</h5>";
		} else {
		...
		if ($correct_option == "cancelled")
			$disp_text = "<h5 class='question_end_info'>Your Prediction Amount will be refunded with in 24 hours, since none of the answer is correct</h5>";
		else {
